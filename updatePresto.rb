...
opts[:vrealms].each do |vrealm|
  ...
  if opts[:verify_only] == true
    ...
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcdb[0]['id'], 'vm_name', vcdb_vm_name) unless vcdb[0]['vm_name'] == vcdb_vm_name
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcdb[0]['id'], 'vcenter_hostname', vcenter_hostname) unless vcdb[0]['vcenter_hostname'] == vcenter_hostname
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcdb[0]['id'], 'datacenter_name', datacenter_name) unless vcdb[0]['datacenter_name'] == datacenter_name
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcdb[0]['id'], 'cluster_name', cluster_name) unless vcdb[0]['cluster_name'] == cluster_name

    #update vcddb if needed
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcddb[0]['id'], 'vm_name', vcddb_vm_name) unless vcddb[0]['vm_name'] == vcddb_vm_name
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcddb[0]['id'], 'vcenter_hostname', vcenter_hostname) unless vcddb[0]['vcenter_hostname'] == vcenter_hostname
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcddb[0]['id'], 'datacenter_name', datacenter_name) unless vcddb[0]['datacenter_name'] == datacenter_name
    update_query(pg, logger, vcda[0]['fqdn'], 'resources', vcddb[0]['id'], 'cluster_name', cluster_name) unless vcddb[0]['cluster_name'] == cluster_name
